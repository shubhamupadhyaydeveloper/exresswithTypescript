...
exports.userHistory = exports.toggleFollowAndUnfollow = exports.playlistByProfile = exports.deletePlaylist = exports.updatePlaylist = exports.togglePlaylist = exports.createPlaylist = exports.createAudio = exports.updateProfile = void 0;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (files.thumbnail) {
                ...
                if (!allowedMimeTypes.includes((_b = files.thumbnail[0]) === null || _b === void 0 ? void 0 : _b.mimetype)) {
                    return res
                        .status(400)
                        .json({
...
function createPlaylist(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            console.log("error in createPlaylist", error === null || error === void 0 ? void 0 : error.message);
        }
    });
}
...
function togglePlaylist(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            console.log("error in togglePlaylist", error === null || error === void 0 ? void 0 : error.message);
        }
    });
}
...
function updatePlaylist(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            console.log("error in updatePlaylist", error === null || error === void 0 ? void 0 : error.message);
        }
    });
}
...
function deletePlaylist(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            console.log("error in deletePlaylist", error === null || error === void 0 ? void 0 : error.message);
        }
    });
}
...
function playlistByProfile(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            console.log("error in playlistByProfile", error === null || error === void 0 ? void 0 : error.message);
        }
    });
}
...
function toggleFollowAndUnfollow(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            console.log("error in toggleFollowAndUnfollow", error === null || error === void 0 ? void 0 : error.message);
        }
    });
}
...
function userHistory(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield history_model_1.default.deleteMany({ userId, timestamp: { $lt: new Date(Date.now() - 30 * 24 * 60 * 60 * 1000) } });
        }
        catch (error) {
            console.log("error in updatehistory", error === null || error === void 0 ? void 0 : error.message);
        }
    });
}
